      ...
      {isSuccess && (
        <div className="p-4 bg-emerald-50 border-1 border-emerald-300 text-emerald-800 rounded-2xl flex items-center gap-3 animate-fade-in shadow-xs">
          ...
          <div className="text-xs">
            <span className="font-bold text-sm block">Inquiry Ticket Registered Successfully!</span>
            Our executive board from Ambey Sales will contact you within 2 working hours.
          </div>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 border border-[#D7E7EA] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#04496D] bg-white font-medium text-text-navy"
            >
              <option value="VITAL_SCREENING">Vital Screening (Starts ₹199)</option>
              <option value="VITALS_CONSULTATION">Vitals + Consultation (Starts ₹399)</option>
              <option value="FOLLOW_UP">Follow-up Consultation (Starts ₹299)</option>
              <option value="SPECIALIST">Specialist Consultation (Starts ₹599)</option>
        ...
        >
          {isSubmitting ? (
            <>
              ...
              Transmitting Ticket Securely...
            </>
          ) : (
            <>
              <Send className="w-4 h-4" /> Send Ticket Confirmation
            </>
          )}
        </button>
      </form>
